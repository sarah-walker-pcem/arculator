...
void loadconfig()
{
	...
	video_black_level = config_get_int(CFG_MACHINE, NULL, "video_black_level", BLACK_LEVEL_ACORN);
...
void saveconfig()
{
	...
	config_set_int(CFG_MACHINE, NULL, "video_black_level", video_black_level);
