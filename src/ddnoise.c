...
void ddnoise_seek(int len)
{
        ...
        if (len < 0) len = -len;
        ddnoise_spos = 0;
        if (len == 0)      { ddnoise_sstat = -1; fdc_time = 200; rpclog("fdc_time set by ddnoise_seek 0\n"); }
        else if (len == 1) { ddnoise_sstat = 0; fdc_time = 2500000; rpclog("fdc_time set by ddnoise_seek 1\n"); }
